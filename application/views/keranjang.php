<div class="container-fluid">
    ...
    <table class="table table-bordered table-striped table-hover">
        ...
        <tr>
            ...
            <td align="righr">Rp. <?php echo number_format($items['subtotal'], 0,',','.')  ?> </td>
        </tr>
    ...
    <div align="right">
        ...
        <a href="<?php echo base_url('dashboard/hapus_keranjang') ?> "><div class="btn btn-sm btn-primary">Lanjutkan Belanja</div></a>
